        ...
        EntityReadOperations
{
    ...
    {
        guard.check();
        return entityReadDelegate.nodesGetById( state, nodeId );
    }
    ...
    {
        guard.check();
        return entityReadDelegate.relationshipsGetById( state, relationshipId );
    }
    ...
    {
        guard.check();
        return entityReadDelegate.graphProperties( state );
    }
}
